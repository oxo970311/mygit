...
print(perch_input.shape)


train_input, test_input, train_target, test_target = train_test_split(perch_input, perch_target, random_state=42)

plt.scatter(train_input[:, 0], train_input[:, 1])
plt.scatter(10, 20, marker='D')
plt.xlabel('length')
plt.ylabel('weight')
plt.show()